...
def send_email(msg,payloadtext,CLASSIFICATION,CLASSIFICATION_CONFIDENCE_SCORE):

    SENDER = "xhn@haonan.tk"
    RECIPIENT = msg['From']
...
def lambda_handler(event, context):
    ...
    return send_email(msg,payloadtext,CLASSIFICATION,CLASSIFICATION_CONFIDENCE_SCORE)